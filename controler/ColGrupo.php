...
class ColGrupo {
    ...
    private $hot_id;
    private $gru_nome;
    private $gru_hot_entrada;
    private $gru_hot_saida;
    ...
    public function incluir() {
        ...
        $sql .="'".$this->gru_hot_entrada."',";
        $sql .="'".$this->gru_hot_saida."',";
    ...
    public function alterar() {
        ...
        $sql .="gru_hot_entrada='".$this->gru_hot_entrada."',";
        $sql .="gru_hot_saida='".$this->gru_hot_saida."',";
